...
public:
	...
	void DrawDataMC(TH1* data, std::vector<TH1*> MC, std::map<std::string, int> nameColMap, TString name, bool log = false, bool normalize = false, bool drawpull = false, TString xlabel = "none", TString ylabel = "# Events");
	void DrawDataMCerror(TGraphErrors* data_stat, TGraphAsymmErrors* data_syst, std::vector<TH1*> MC, std::map<std::string, int> nameColMap, TString name, bool log = false, bool normalize = false, bool drawpull = false, TString xlabel = "none", TString ylabel = "# Events");
